...
exports.run = async (client, message, args) => {
  ...
  .addField(`:book: **Exemplo**`, `\`${c.prefix}ascii young\``, true)
  ...
  .setColor('#a67dff')     
    ...
    const tooLong = `<:alert:696822589208920124> **»** Kon'nichiwa **${message.author.username}**, o texto é muito longo, tente um texto menor.`;
