...
exports.run = async (client, message, args) => {
    ...
    if (!message.mentions.users.first()) return message.channel.send(`<:alert:696822589208920124> **»** Kon'nichiwa **${message.author.username}**, você precisa mencionar um membro.`);
